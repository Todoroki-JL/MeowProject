...
(function () {
    ...
    var amount = Number(parameters['Required Amount'] || '5');
    var itemID = Number(parameters['Required Item ID'] || '10');
    ...
    Scene_Gacha.prototype.createCommandWindow = function () {
        this._commandWindow = new Window_GachaCommand(Graphics.boxWidth / 3*2, this._purchaseOnly);
    ...
    Scene_Gacha.prototype.createStoneWindow = function () {
    	  var gw = Graphics.boxWidth - this._commandWindow.width;
    	  this._stoneWindow = new Window_Base(this._commandWindow.width, this._helpWindow.height, gw, this._commandWindow.height);
        this.addWindow(this._stoneWindow);
    };
